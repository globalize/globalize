...
class FirstOrCreateTest < Test::Unit::TestCase
  if ::ActiveRecord::VERSION::STRING >= "3.2.1"
    test 'first_or_create with translations when row exists' do
    ...
    test 'first_or_create with translations when row does not exist' do
    ...
    test 'first_or_create with translated and untranslated attributes' do
    ...
    test 'model should not have first_or_create method' do
