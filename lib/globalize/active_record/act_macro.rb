  ...
  module ActiveRecord
    module ActMacro
      ...
      def allow_translation_of_attributes(attr_names)
        ...
        begin
          if Globalize.rails_5? && connected? && table_exists? && translation_class.table_exists?
      ...
      def check_columns!(attr_names)
        ...
        return unless Globalize.rails_42? && connected? && table_exists? && translation_class.table_exists?
