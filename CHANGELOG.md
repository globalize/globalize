...
* Fix broken pluralization with Rails 8.1 (wrong, singular table names) [#847](https://github.com/globalize/globalize/issues/847)
* Remove support for Rails versions lower than 7.2 and Ruby versions lower than 3.1
